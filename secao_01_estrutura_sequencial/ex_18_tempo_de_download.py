...
def calcular_tempo_de_download():
    ...
    tamanho_do_arquivo = int(input('Qual é o tamanho do arquivo em MB:? ')) * 8
    velocidade_da_internet = int(input('Qual é a velocidade em Mbps? ')) * 60
    tempo_de_download = tamanho_do_arquivo / velocidade_da_internet
    print(f'O tempo aproximado do Download é: {tempo_de_download:.0f} minuto(s)')
