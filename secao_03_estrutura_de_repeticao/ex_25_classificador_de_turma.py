...
def classifcar_turma(*idades) -> str:
    ...
    if media > 0 and media <= 25:
        classificacao = f'A turma é jovem, pois a média é de {media:.1f} anos'
    elif media >= 26 and media < 60:
        classificacao = f'A turma é adulta, pois a média é de {media:.1f} anos'
    else:
        classificacao = f'A turma é idosa, pois a média é de {media:.1f} anos'
